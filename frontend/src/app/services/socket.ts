...
import { refreshCategoriesObservable, refreshMovimentationsObservable, refreshProductsObservable } from "../misc/observables";
...
export class SocketService {
    ...
    constructor(private configService: ConfigService, private toastService: ToastService) {
        ...
        this.socketEvents.push({
            topic: ISocketTopic.REFRESH_MOVIMENTATIONS,
            fn: (message: ISocketMessage) => {
                refreshMovimentationsObservable.next(message.message);
            }}
        )
